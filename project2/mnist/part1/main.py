...
new_n_components = 10
train_pca10 = project_onto_PC(train_x, pcs, new_n_components, feature_means)
test_pca10 = project_onto_PC(test_x, pcs, new_n_components, feature_means)
...
def run_softmax_on_MNIST_pca_cube(temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
...
# print('softmax test_error pca cube =', run_softmax_on_MNIST_pca_cube(temp_parameter=1))
